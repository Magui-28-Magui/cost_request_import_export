...
namespace DataExporter
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Export importer = new Export(server, dbuser, dbpassword, databaseName);

            ImportExportDataLibrary.Response response = importer.ExportToExcel(fileName, sheetName, columns, databaseTableName, fields, types);
